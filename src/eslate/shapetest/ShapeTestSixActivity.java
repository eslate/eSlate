...
public class ShapeTestSixActivity extends Activity  implements OnClickListener{
	MediaPlayer mediaPlayer=new MediaPlayer();
	Toast toast;
	ImageButton hexabtn, trianlebtn, squarebtn,starbtn,ovalbtn;
@Override
protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.shapetestsix_layout);
		...
		Uri path=Uri.parse("android.resource://"+getPackageName()+"/"+R.raw.starques);
		mediaPlayer=MediaPlayer.create(ShapeTestSixActivity.this, path);
		mediaPlayer.start();
...
public void onClick(final View v) {
        ...
        case R.id.hexabtn:
							...
							mediaPlayer.stop();
							mediaPlayer.release();							
							Intent act2 = new Intent(ShapeTestSixActivity.this,ShapeTestSixActivity.class);
		...
		case R.id.ovalbtn:
							...
							mediaPlayer=MediaPlayer.create(ShapeTestSixActivity.this, path1);
							mediaPlayer.start();
							v.setEnabled(false);
							squarebtn.setEnabled(false);
							trianlebtn.setEnabled(false);
        ...
        case R.id.squarebtn:
        					...
        					mediaPlayer=MediaPlayer.create(ShapeTestSixActivity.this, path2);
        					mediaPlayer.start();
        					v.setEnabled(false);
        					hexabtn.setEnabled(false);
        					trianlebtn.setEnabled(false);
        ...
        case R.id.starbtn:	
        					...
        					mediaPlayer=MediaPlayer.create(ShapeTestSixActivity.this, path3);
        					mediaPlayer.start();
        					v.setEnabled(false);
        					squarebtn.setEnabled(false);
        					...
        					Intent act2 = new Intent(ShapeTestSixActivity.this,ShapeTestSevenActivity.class);
        					act2.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        					startActivity(act2);
        					finish();
        					}
        ...
        case R.id.trianglebtn:
        					...
        					mediaPlayer=MediaPlayer.create(ShapeTestSixActivity.this, path4);
        					mediaPlayer.start();
        					v.setEnabled(false);
        					squarebtn.setEnabled(false);
        					hexabtn.setEnabled(false);
...
public boolean onOptionsItemSelected(MenuItem item) {
		...
		Intent home=new Intent(ShapeTestSixActivity.this,eslate.preparation.main.Eslate_preparatrion_MainActivity.class);
...
public void onBackPressed() {
	 final Dialog dialog = new Dialog(ShapeTestSixActivity.this,AlertDialog.THEME_HOLO_LIGHT);
