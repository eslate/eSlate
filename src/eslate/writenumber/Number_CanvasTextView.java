...
public class Number_CanvasTextView extends TextView {
	...
	public Number_CanvasTextView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		this.context = context;
		initialize(context);
	}

	public Number_CanvasTextView(Context context, AttributeSet attrs) {
		super(context, attrs);
		this.context = context;
		initialize(context);
	}

	public Number_CanvasTextView(Context context) {
		super(context);
