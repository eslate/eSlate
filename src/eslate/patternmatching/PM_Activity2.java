...
public class PM_Activity2 extends Activity implements OnClickListener{
...
protected void onCreate(Bundle savedInstanceState) {
	...
	setContentView(R.layout.pm_activity2);
	...
	if (hasOnce==false) {
		...
		case R.id.imageButton14:
			...
			public void onCompletion(MediaPlayer mp) {
				...
				Intent next = new Intent(PM_Activity2.this,PM_Activity3.class);
...
public boolean onOptionsItemSelected(MenuItem item) {
		...
		Intent home=new Intent(PM_Activity2.this,eslate.preparation.main.Eslate_preparatrion_MainActivity.class);
...
public void onBackPressed() {
	 final Dialog dialog = new Dialog(PM_Activity2.this,AlertDialog.THEME_HOLO_LIGHT);
