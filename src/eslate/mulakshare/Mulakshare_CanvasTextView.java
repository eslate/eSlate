...
public class Mulakshare_CanvasTextView extends TextView {
	...
	public Mulakshare_CanvasTextView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		this.context = context;
		initialize(context);
	}

	public Mulakshare_CanvasTextView(Context context, AttributeSet attrs) {
		super(context, attrs);
		this.context = context;
		initialize(context);
	}

	public Mulakshare_CanvasTextView(Context context) {
		super(context);
