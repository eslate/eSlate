...
/** This activity is for Pattern Differing.here we are given some images from which one 
 * except one all are same and student has to identify that different image.if student 
 * answer correct then next row will appear with same question but always with different images.
***/

public class Pattern_Diff_Activity1 extends Activity implements OnClickListener{
	// declaring these are imagebutton refrences  
	ImageButton img1,img2,img3,img4,img5,img6,img7,img8,img9,img10,img11,img12,img13,img14,img15;
	// declaring three linear layout rrefrences
...
protected void onCreate(Bundle savedInstanceState) {
	...
	setContentView(R.layout.patterdiff_activity1_layout);
	...
	//getting refrences of linear layout
	...
	if (hasOnce==false) {
		...
		case R.id.imageButton14:
			...
			public void onCompletion(MediaPlayer mp) {
				...
				Intent next = new Intent(Pattern_Diff_Activity1.this,Pattern_Diff_Activity2.class);
...
public boolean onOptionsItemSelected(MenuItem item) {
	...
	Intent home=new Intent(Pattern_Diff_Activity1.this,eslate.preparation.main.Eslate_preparatrion_MainActivity.class);
...
public void onBackPressed() {
	 final Dialog dialog = new Dialog(Pattern_Diff_Activity1.this,AlertDialog.THEME_HOLO_LIGHT);
