...
public class ShapeTestThreeActivity extends Activity implements OnClickListener{
...
protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.shapetestthree_layout);
		...
		Uri path=Uri.parse("android.resource://"+getPackageName()+"/"+R.raw.squareques);
...
public void onClick(final View v) {
        ...
        case R.id.circlebtn:
							...
							mediaPlayer=MediaPlayer.create(ShapeTestThreeActivity.this, path);
							mediaPlayer.start();
							v.setEnabled(false);
							squarebtn.setEnabled(false);
							trianlebtn.setEnabled(false);
							...
							Intent act2 = new Intent(ShapeTestThreeActivity.this,ShapeTestThreeActivity.class);
		...
		case R.id.ovalbtn:
							...
							mediaPlayer=MediaPlayer.create(ShapeTestThreeActivity.this, path1);
							mediaPlayer.start();
							v.setEnabled(false);
							squarebtn.setEnabled(false);
							trianlebtn.setEnabled(false);
        ...
        case R.id.squarebtn:
        					...
        					mediaPlayer=MediaPlayer.create(ShapeTestThreeActivity.this, path2);
        					this.m1();
        					mediaPlayer.start();
        					v.setEnabled(false);
        					circlebtn.setEnabled(false);
							...
							Intent act2 = new Intent(ShapeTestThreeActivity.this,ShapeTestFourActivity.class);
							act2.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
							startActivity(act2);
							finish();
        					}
        ...
        case R.id.rectanglebtn:
        				...
        				mediaPlayer=MediaPlayer.create(ShapeTestThreeActivity.this, path3);
        				mediaPlayer.start();
        				v.setEnabled(false);
        				squarebtn.setEnabled(false);
        				trianlebtn.setEnabled(false);
        ...
        case R.id.trianglebtn:
        				...
        				mediaPlayer=MediaPlayer.create(ShapeTestThreeActivity.this, path4);
        				mediaPlayer.start();
        				v.setEnabled(false);
        				squarebtn.setEnabled(false);
        				circlebtn.setEnabled(false);
...
public boolean onOptionsItemSelected(MenuItem item) {
		...
		Intent home=new Intent(ShapeTestThreeActivity.this,eslate.preparation.main.Eslate_preparatrion_MainActivity.class);
...
public void onBackPressed() {
	 final Dialog dialog = new Dialog(ShapeTestThreeActivity.this,AlertDialog.THEME_HOLO_LIGHT);
