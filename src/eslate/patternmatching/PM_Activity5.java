...
public class PM_Activity5 extends Activity implements OnClickListener{
...
protected void onCreate(Bundle savedInstanceState) {
	...
	setContentView(R.layout.pm_activity5);
	...
	//Row One
	img1 = (ImageButton)findViewById(R.id.imageButton1);//S
	...
	if (hasOnce==false) {
		...
		case R.id.imageButton14:
			...
			public void onCompletion(MediaPlayer mp) {
				...
				Intent next = new Intent(PM_Activity5.this,eslate.patterndiffering.Pattern_Diff_Activity1.class);
...
public boolean onOptionsItemSelected(MenuItem item) {
		...
		Intent home=new Intent(PM_Activity5.this,eslate.preparation.main.Eslate_preparatrion_MainActivity.class);
...
public void onBackPressed() {
	 final Dialog dialog = new Dialog(PM_Activity5.this,AlertDialog.THEME_HOLO_LIGHT);
