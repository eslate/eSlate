...
public class ShapeTestFourActivity extends Activity implements OnClickListener{
	MediaPlayer mediaPlayer;
	Toast toast;
	ImageButton imagebtn,starbtn, trianlebtn, squarebtn,rectaglebtn,ovalbtn;
@Override
protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.shapetestfour_layout);
        ...
        Uri path=Uri.parse("android.resource://"+getPackageName()+"/"+R.raw.rectques);
		mediaPlayer=MediaPlayer.create(ShapeTestFourActivity.this, path);
		mediaPlayer.start();
...
public void onClick(final View v) {
        ...
        case R.id.starbtn:	
							...
							Intent act2 = new Intent(ShapeTestFourActivity.this,ShapeTestFourActivity.class);
		...
		case R.id.ovalbtn:
							...
							mediaPlayer=MediaPlayer.create(ShapeTestFourActivity.this, path1);
							mediaPlayer.start();
							v.setEnabled(false);
							squarebtn.setEnabled(false);
							trianlebtn.setEnabled(false);
        ...
        case R.id.squarebtn:
        					...
        					mediaPlayer=MediaPlayer.create(ShapeTestFourActivity.this, path2);
        					mediaPlayer.start();
        					v.setEnabled(false);
        					starbtn.setEnabled(false);
        					trianlebtn.setEnabled(false);
        ...
        case R.id.rectanglebtn:		
        				...
        				mediaPlayer=MediaPlayer.create(ShapeTestFourActivity.this, path3);
        				mediaPlayer.start();
        				v.setEnabled(false);
        				squarebtn.setEnabled(false);
        				...
        				public void onCompletion(MediaPlayer mp) {
        					...
        					Intent act2 = new Intent(ShapeTestFourActivity.this,ShapeTestFiveActivity.class);
        					act2.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        					startActivity(act2);
        					finish();
        					}
        ...
        case R.id.trianglebtn:
        				...
        				mediaPlayer=MediaPlayer.create(ShapeTestFourActivity.this, path4);
        				mediaPlayer.start();
        				v.setEnabled(false);
        				squarebtn.setEnabled(false);
        				starbtn.setEnabled(false);
...
public boolean onOptionsItemSelected(MenuItem item) {
		...
		Intent home=new Intent(ShapeTestFourActivity.this,eslate.preparation.main.Eslate_preparatrion_MainActivity.class);
...
public void onBackPressed() {
	 final Dialog dialog = new Dialog(ShapeTestFourActivity.this,AlertDialog.THEME_HOLO_LIGHT);
