...
public class PM_Activity3 extends Activity implements OnClickListener{
...
protected void onCreate(Bundle savedInstanceState) {
	...
	setContentView(R.layout.pm_activity3);
	...
	img4 = (ImageButton)findViewById(R.id.imageButton2);//A
	...
	img15 =(ImageButton)findViewById(R.id.imageButton15);//A
	...
	if (hasOnce==false) {
		...
		case R.id.imageButton15:
			...
			public void onCompletion(MediaPlayer mp) {
				...
				Intent next = new Intent(PM_Activity3.this,PM_Activity4.class);
...
public boolean onOptionsItemSelected(MenuItem item) {
		...
		Intent home=new Intent(PM_Activity3.this,eslate.preparation.main.Eslate_preparatrion_MainActivity.class);
...
public void onBackPressed() {
	 final Dialog dialog = new Dialog(PM_Activity3.this,AlertDialog.THEME_HOLO_LIGHT);
