...
//this is left right test third activity
public class LRTest3 extends Activity implements OnClickListener{
    ImageView line, moon, moons;
    Toast toast;
...
protected void onCreate(Bundle savedInstanceState) {
	...
	setContentView(R.layout.lrtest3_activity);
    ...
    moons= (ImageView)findViewById(R.id.moons);
    moons.setOnClickListener(this);
	...
	if (hasOnce==false) {
		...
		case R.id.moon:
			...
			Intent intent=new Intent(LRTest3.this, ABLRScoreActivity.class);
		...
		case R.id.moons:
			...
			//since here moon is right attempt we increase  score value by one
				ABTest1.score++;
				ques6++;
				Intent intent=new Intent(LRTest3.this, ABLRScoreActivity.class);
				intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
	...
	public void onBackPressed() {
		 final Dialog dialog = new Dialog(LRTest3.this,AlertDialog.THEME_HOLO_LIGHT);
